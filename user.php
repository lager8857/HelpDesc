        ...
        <form action="user_send.php" method="post">
            <fieldset disabled id="test">
                <div class="form-group">
                    ...
                    <input type="text" id="disabledTextInput" name="surname" required class="form-control"
                           placeholder="<?php echo $surname ?>">
                </div>
                <div class="form-group">
                    <label for="disabledTextInput">Имя</label>
                    <input type="text" id="disabledTextInput" name="firstname" required class="form-control"
                           placeholder="<?php echo $firstname ?>">
                </div>

                <div class="form-group">
                    <label for="disabledTextInput">Отчество</label>
                    <input type="text" id="disabledTextInput" name="middlename" required class="form-control"
                           placeholder="<?php echo $middlename ?>">
                </div>
                <div class="form-group">
                    <label for="disabledTextInput">Email</label>
                    <input type="text" id="disabledTextInput" name="email" required class="form-control"
        ...
        <form action="send_mess.php" method="post">
            <fieldset disabled id="test1">
                <div class="form-group">
                    ...
                    <input type="text" required id="disabledTextInput" name="surname" class="form-control"
                           placeholder="<?php echo $message ?>">
                </div>
                <div class="form-group">
                    <label for="disabledTextInput">Проблема</label>
                    <input type="text" required id="disabledTextInput" name="firstname" class="form-control"
                           placeholder="<?php echo $tema ?>">
                </div>
                <div class="form-group">
