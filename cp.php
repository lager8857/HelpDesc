...
';
        ...
        <div class="container-fluid">
            <div class="form-group col-md-3">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="1" name="date1"
                          required></textarea>
            </div>
            <div class="form-group col-md-3">
                <label for="exampleFormControlTextarea1">Введите дату до:</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="1" name="date2"
                          required></textarea>
