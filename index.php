                        ...
                        <div class="col-md-7" id="ticket-area">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form action="send_mess.php" class="form-horizontal" enctype="multipart/form-data"
                                          method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="hidden" class="form-control" name="autor"
                                                       value="<?php echo $id ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 ui-front">
                                                <textarea name="mess" style="height: 200px; width: 611px !important"
                        ...
                        <div class="col-md-4 col-md-offset-1" id="knowledge-area">
                            ...
                            <div class="list-group">
                                <a href="#" class="list-group-item active"
                                   style="word-wrap:break-word; overflow: visible !important;">
                                    <h4 class="list-group-item-heading">База знаний</h4>
                                </a>
                                <a href="#" class="list-group-item">
                                    <h4 class="list-group-item-heading">Не рабочий принтер</h4>
                                    <p class="list-group-item-text">Если у вас сломался принтер, то вам стоить проверить
                                        питание и ... </p>
                                </a>
                                <a href="#" class="list-group-item">
                                    <h4 class="list-group-item-heading">Как отправть запрос</h4>
                                    <p class="list-group-item-text">Вам нужно зайти на страницу поддержки пользователей
                                        и написать ... </p>
                                </a>
                                <a href="#" class="list-group-item">
                                    <h4 class="list-group-item-heading">Не работает клавиатура</h4>
                                    <p class="list-group-item-text">Если вы не можете набрать текст на клавиатуре и
                                        клавиши не работают, то ... </p>
                                </a>
                                <a href="#" class="list-group-item">
                                    <h4 class="list-group-item-heading">Интернет медленно работает</h4>
                                    <p class="list-group-item-text">Вам стоит перезагрузить роутер.</p>
                                </a>
                            </div>
