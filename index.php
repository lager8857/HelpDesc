...
<form action="send_mess.php" class="form-horizontal" enctype="multipart/form-data" method="post" >
        ...
        <div class="form-group">
                ...
                <div class="col-md-9 ui-front">
                    <input type="text" class="form-control" id='article-title' name="subject" value="">
                </div>
        </div>
                    <div class="form-group">
        ...
        <div class="form-group">
                <div class="col-md-12 ui-front">
                    <textarea name="mess" style="height: 200px; width: 611px !important" id="ticket-body"></textarea>
                </div>
        </div>
...
<div class="list-group">
    ...
    <p class="list-group-item-text">Если у вас сломался принтер, то вам стоить проверить питание и ... </p>
  </a>
      <a href="#" class="list-group-item">
    <h4 class="list-group-item-heading">Как отправть запрос</h4>
    <p class="list-group-item-text">Вам нужно зайти на страницу поддержки пользователей и написать ... </p>
  </a>
      <a href="#" class="list-group-item">
    <h4 class="list-group-item-heading">Не работает клавиатура</h4>
    <p class="list-group-item-text">Если вы не можете набрать текст на клавиатуре и клавиши не работают, то ... </p>
  </a>
      <a href="#" class="list-group-item">
