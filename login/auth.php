...
if (isset($_POST["btn_submit_auth"])) {
    ...
    /**
     * Тут полная дичь
     * @see https://www.php.net/manual/ru/ref.password.php
     */
    //======= Обработка пароля ============
    ...
    /**
     * по паролю никто не ищет, всегда выберается пользователь а потом
     * происходит валидация пароля
     * @see https://www.php.net/manual/ru/function.password-verify.php
     */
