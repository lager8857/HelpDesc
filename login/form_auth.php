...
?>
<body>
<!--Это перекинуть в папку js и в header подключить-->
            ...
            <div class="container_form">
                ...
                <form action="auth.php" method="POST" name="form_auth">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInput123" name="username" minlength="2"
                               maxlength="255" required aria-describedby="usernameHelp" placeholder="Введите логин">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="exampleInputPassword1" name="password"
                               minlength="6" maxlength="255" required placeholder="Минимум 6 символов">
