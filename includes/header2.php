                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-offset-2 col-md-8 header-search">
                            ...
                            <form action="http://support.patchesoft.com/client/knowledge_search" method="post" accept-charset="utf-8">
<input type="hidden" name="csrf_test_name" value="6371ec9d4145c5f1c1b48a455fb0c478" />                                                                                                                             
                            <div class="input-group">
                            <input type="text" name="search" class="form-control input-lg" placeholder="Задайте вопрос" />
