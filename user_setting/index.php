...
<?php 
	...
	$zapr_user = $mysqli->query("SELECT user1.username,user1.firstname,user1.surname,user1.middlename,user1.email,user_group.name FROM user1,user_group WHERE (user1.user_group=user_group.id) AND (user1.id= $id)");
